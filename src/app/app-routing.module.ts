...
export const routeProps: Routes = [
  ...
  },
  {
    ...
    title: 'Setup',
    loadChildren: () =>
      import('./coffee/setup/setup.module').then((m) => m.SetupModule),
  },
  {
    path: 'join',
    title: 'Join',
  ...
  },
  {
    ...
    title: 'Participant',
    loadChildren: () =>
      import('./coffee/participant/participant.module').then(
  ...
  },
  {
    ...
    title: 'Board',
    loadChildren: () =>
      import('./dashboard/board/board.module').then((m) => m.BoardModule),
  },
  {
    path: 'users',
    title: 'Users',
